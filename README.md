...
2. Upload `ai-learning-platform.zip` via the Colab file explorer
3. Paste your Groq key and ngrok token in Cell 2
4. Run cells top to bottom — Cell 3 prints your public URL
